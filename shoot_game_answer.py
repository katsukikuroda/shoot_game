...
while True:
    ...
    #         p_y = timer_height
        ...
        #     if p_x + p_width/2 + p_laser_width/2 <= closest_enemy[0]:
        #         if p_x < WIDTH - p_width:
        #             p_x += p_v
        #     elif p_x + p_width/2 - p_laser_width/2 >= closest_enemy[0] + e_width:
        #         if p_x > 0:
        #             p_x -= p_v
        #     elif p_x + p_width/2 + p_laser_width/2 > closest_enemy[0] and p_x + p_width/2 - p_laser_width/2 < closest_enemy[0] + e_width:
